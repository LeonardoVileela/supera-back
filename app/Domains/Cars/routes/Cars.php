...
Route::get('/all', [\App\Domains\Cars\Http\Controllers\CarController::class, 'all'])->middleware('auth:sanctum');
...
Route::get('/all-next-maintenance', [\App\Domains\Cars\Http\Controllers\CarController::class, 'allNextMaintenance'])->middleware('auth:sanctum');
